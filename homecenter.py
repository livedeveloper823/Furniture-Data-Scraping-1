        ...
        try:
            ...
            for properties in product_details:
                ...
                if classification == "Dimensiones":
                    ...
                    characteristics = properties.find_elements(By.CLASS_NAME, "attribute")
                    for characteristic in characteristics: 
                        if characteristic.find_element(By.CLASS_NAME, "key").text == "Número de cuerpos":
                            body_num = characteristic.find_element(By.CLASS_NAME, "value").text
                            sheet[f'N{match_num + 2}'] = body_num
                            ...
                            sheet[f'O{match_num + 2}'] = tapestry_material
                            ...
                            sheet[f'P{match_num + 2}'] = warranty_terms
                            ...
                            sheet[f'Q{match_num + 2}'] = original
                            ...
                            sheet[f'R{match_num + 2}'] = structure_material
                            ...
                            sheet[f'S{match_num + 2}'] = product_guarantee
                        elif characteristic.find_element(By.CLASS_NAME, "key").text == "Tipo":
                            tipo = characteristic.find_element(By.CLASS_NAME, "value").text
                            sheet[f'T{match_num + 2}'] = tipo
                            ...
                            sheet[f'AF{match_num + 2}'] = drawers_num
                            ...
                            sheet[f'AQ{match_num + 2}'] = comfort_level
                            ...
                            sheet[f'AT{match_num + 2}'] = mattress_color
